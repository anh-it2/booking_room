import { NavItem, ProfileNavItem } from '@/types';
...
export const navProfileItems: ProfileNavItem[] = [
  {
    title: 'Profile',
    url: '/dashboard/admin/profile',
    icon: 'user',
    ...
    title: 'Security',
    url: '/dashboard/admin/profile/security',
    icon: 'security',
    items: []
  }
]
