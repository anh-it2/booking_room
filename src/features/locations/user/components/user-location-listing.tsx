...
import { userLocationColumns } from './locations-table/userLocationColumn';

type UserLocationListingPage = {};

export default  function UserLocationListingPage({}: UserLocationListingPage) {
  ...
  return (
    ...
    :  <LocationTable
        ...
        columns={userLocationColumns(setLocations)}
      />}
    </>
  );
}
