...
export const locationColumns= (setLocations: React.Dispatch<React.SetStateAction<Location[]>>): ColumnDef<Location>[] => [
  {
    accessorKey: 'id',
    header: 'ID'
  },
  ...
  {
    id: 'actions',
    cell: ({ row }) => <CellAction data={row.original} setLocations={setLocations}/>
  },
];
