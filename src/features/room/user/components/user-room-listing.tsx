...
import { initData } from '@/constants/apiRoom';
...
import { userRoomColumns } from './room-table/userRoomColumn';


type UserRoomListingPage = {};

export default  function UserRoomListingPage({}: UserRoomListingPage) {
  ...
  useEffect(() =>{
    ...
    async function fetchData() {
      ...
      const data = initData.getRooms(filters)
  ...
  return (
    ...
    :  <RoomTable
        ...
        columns={userRoomColumns(setRooms)}
      />}
    </>
  );
}
